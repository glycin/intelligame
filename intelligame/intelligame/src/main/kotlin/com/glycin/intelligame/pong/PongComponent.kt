...
class PongComponent(
    ...
    private fun drawPlayers(g: Graphics2D) {
        ...
        g.fillRect(p2Brick.position.x.roundToInt(), p2Brick.position.y.roundToInt(), p2Brick.width, p2Brick.height)
    }
    ...
    private fun drawGoals(g: Graphics2D) {
        ...
        g.color = goal2.color
        g.fillRect(goal2.position.x.roundToInt(), goal2.position.y.roundToInt(), goal2.width, goal2.height)
    }
}